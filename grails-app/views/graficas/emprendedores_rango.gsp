            ...
            <div  id="view" style="overflow-x:auto;">
				<!--  ${raw(html_cod)}-->
				 <div class="contenedor_ramificaciones tree" id="board">
                            	<ul>
                                    <li>
                                        <img src="${request.contextPath}/images/organizacion/Proyeccion/oro_m1.png">
                                        <ul>
                                            <li>
                                            	<div class="notif_modal_proxsubirrango" title="Próximo a subir de rango">
													<div class="cerrarmodal_notif"></div>
												</div>
                                                <img src="${request.contextPath}/images/organizacion/Proyeccion/esi_m2.png" class="popover-markup-dts">
                                                            ...
                                                            <li>
			                                                    ...
			                                                    <li>
			                                                        <ul>
			                                                            ...
			                                                            <li>
			                                                                <img src="${request.contextPath}/images/organizacion/Proyeccion/esi_m2.png">
			                                                            </li>
			                                                            <li>
			                                                                <img src="${request.contextPath}/images/organizacion/Proyeccion/esi_m2.png">
			                                                            </li>
                                            ...
                                            <li>
                                                <img src="${request.contextPath}/images/organizacion/Proyeccion/bronce_m2.png" class="popover-markup-dts">
	                                            <div class="head hide" >Guadalupe Reyes Mancho</div>
						    					<div class="content hide">
						    						<i class="glyphicon glyphicon-earphone icono_infox"></i>
						    						<i class="glyphicon glyphicon-envelope icono_infox"></i>
                                                ...
                                                <ul>
                                                    <li>
                                                        <ul>
                                                            <li>
                                                                <img src="${request.contextPath}/images/organizacion/Proyeccion/bronce_m2.png">
                                                            </li>
                                                            <li>
                                                                <img src="${request.contextPath}/images/organizacion/Proyeccion/bronce_m2.png">
                                                            </li>
                                            ...
                                            <li>
                                                <img src="${request.contextPath}/images/organizacion/Proyeccion/plata_m2.png" class="popover-markup-dts">
                                                <div class="head hide" >Guadalupe Reyes Mancho</div>
						    					<div class="content hide">
						    						<i class="glyphicon glyphicon-earphone icono_infox"></i>
						    						<i class="glyphicon glyphicon-envelope icono_infox"></i>
                                                ...
                                                <ul>
                                                    <li>
                                                        <ul>
                                                            <li>
                                                                <img src="${request.contextPath}/images/organizacion/Proyeccion/plata_m2.png">
                                                            </li>
                                                            <li>
                                                                <img src="${request.contextPath}/images/organizacion/Proyeccion/plata_m2.png">
                                                            </li>
                                            ...
                                            <li>
                                                <img src="${request.contextPath}/images/organizacion/Proyeccion/oro_m2.png" class="popover-markup-dts">
                                                ...
                                                <ul>
                                                    <li>
                                                        <ul>
                                                            <li>
                                                                <img src="${request.contextPath}/images/organizacion/Proyeccion/oro_m2.png">
                                                                <ul>
			                                                            <li>
			                                                                <img src="${request.contextPath}/images/organizacion/Proyeccion/oro_m2.png">
			                                                            </li>
                                                            ...
                                                            <li>
                                                                <img src="${request.contextPath}/images/organizacion/Proyeccion/platino_m2.png">
                                                            </li>
                                                            <li>
                                                                <img src="${request.contextPath}/images/organizacion/Proyeccion/platino_m2.png">
                                                            </li>
                                            ...
                                            <li>
                                                <img src="${request.contextPath}/images/organizacion/Proyeccion/diamante_m2.png" class="popover-markup-dts">
                                                ...
                                                <ul>
                                                    <li>
                                                        <ul>
                                                            <li>
                                                                <img src="${request.contextPath}/images/organizacion/Proyeccion/diamante_m2.png">
                                                            </li>
                                                            <li>
                                                                <img src="${request.contextPath}/images/organizacion/Proyeccion/diamante_m2.png">
                                                            </li>
