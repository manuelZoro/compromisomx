            ...
            <div  id="view" style="overflow-x:auto;">
				<!--  ${raw(html_cod)}-->
				 <div class="contenedor_ramificaciones tree" id="board">
                            	<ul>
                                    <li>
                                        <img src="${request.contextPath}/images/organizacion/activo_m1.png">
                                        <ul>
                                            <li>
                                                <img src="${request.contextPath}/images/organizacion/Emprendedores/activo_m2.png" class="popover-markup-dts">
                                                            ...
                                                            <li>
			                                                    ...
			                                                    <li>
			                                                        <ul>
			                                                            ...
			                                                            <li>
			                                                                <img src="${request.contextPath}/images/organizacion/Emprendedores/activo_m2.png">
			                                                            </li>
			                                                            <li>
			                                                                <img src="${request.contextPath}/images/organizacion/Emprendedores/activo_m2.png">
			                                                            </li>
                                            ...
                                            <li>
                                                <img src="${request.contextPath}/images/organizacion/Emprendedores/inactivo_m2.png" class="popover-markup-dts">
	                                            <div class="head hide" >Guadalupe Reyes Mancho</div>
						    					<div class="content hide">
						    						<i class="glyphicon glyphicon-earphone icono_infox"></i>
						    						<i class="glyphicon glyphicon-envelope icono_infox"></i>
                                                ...
                                                <ul>
                                                    <li>
                                                        <ul>
                                                            <li>
                                                                <img src="${request.contextPath}/images/organizacion/Emprendedores/inactivo_m2.png">
                                                            </li>
                                                            <li>
                                                                <img src="${request.contextPath}/images/organizacion/Emprendedores/inactivo_m2.png">
                                                            </li>
                                            ...
                                            <li>
                                                <img src="${request.contextPath}/images/organizacion/Emprendedores/suspendido_m2.png" class="popover-markup-dts">
                                                ...
                                                <ul>
                                                    <li>
                                                        <ul>
                                                            <li>
                                                                <img src="${request.contextPath}/images/organizacion/Emprendedores/suspendido_m2.png">
                                                                <ul>
			                                                            <li>
			                                                                <img src="${request.contextPath}/images/organizacion/Emprendedores/suspendido_m2.png">
			                                                            </li>
                                            ...
                                            <li>
                                                <img src="${request.contextPath}/images/organizacion/sincolor_m2.png" class="popover-markup-dts">
                                                ...
                                                <ul>
                                                    <li>
                                                        <ul>
                                                            <li>
                                                                <img src="${request.contextPath}/images/organizacion/sincolor_m2.png">
                                                            </li>
                                                            <li>
                                                                <img src="${request.contextPath}/images/organizacion/sincolor_m2.png">
                                                            </li>
