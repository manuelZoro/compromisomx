			...
			<g:form action="siguiente6_1">
				<div class="body">
					...
					${session.p6cpasatiempo}<br> <font size=6>Paso 6: Nuestro
						Movimiento / Informacion Personal Tallas Dama</font>

					<div class="row">
						Playera:* <select name="dplayera" class="form-control" style="width: 400px">
					...
					<div class="row">
						Camisa:* <select name="dcamisa" class="form-control" style="width: 400px">
						<OPTION value=1>Extra chica</OPTION>
						<OPTION value=2>Chica</OPTION>
						<OPTION value=3>Mediana</OPTION>
						<OPTION value=4>Grande</OPTION>
					...
					<div class="row">
						Zapatos:* <select name="dzapatos" class="form-control" style="width: 400px">
