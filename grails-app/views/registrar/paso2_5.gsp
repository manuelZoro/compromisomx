...
<body role="document">
	...
	<div class="container theme-showcase" role="main">
		...
		${pasow}
		<div>
			<g:form action="siguiente2_5">

				<div class="body">
				
					Datos:</br>
					${session.p2nombreusuario}</br>
					${session.p2contrasena}</br>
					${session.p2confirmarcontrasena}</br>

					<font size=6>Paso 2:
						Creacion de la cuenta</font> <br /> <font size=4>Co-aplicante</font>
					<div class="row">
						Nombre(s):* <input type="text" class="form-control"
							name="conombre" style="width: 400px" required>
					</div>
					<div class="row">
						Primer apellido:* <input type="text" class="form-control"
							name="coprimerapellido" style="width: 400px" required>
					</div>
					<div class="row">
						Segundo apellido: <input type="text" class="form-control"
							name="cosegundoapellido" style="width: 400px">
					</div>
					<p>
