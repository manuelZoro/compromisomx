...
<body>
	...
	<g:if test="${session.registro_cuenta_aut!=null}">
		<script type="text/javascript">
				...
				document.getElementById("grupo1").value = '${session.registro_cuenta_aut.autoformadeenvio}';
				
				document.getElementById("formapago").value = '${session.registro_cuenta_aut.autotipotarjetaformapago}';
				document.getElementById("fpago").value = '${session.registro_cuenta_aut.autopagotipotarjeta}';
