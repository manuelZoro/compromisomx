...
<body role="document">
	...
	<div class="container theme-showcase" role="main">
		...
		${pasow}
		<div>
			<g:form action="paso1_1">
				<div class="body">
					<br /> Nombre de usuario o ID de Mentor <input width="400"
						type="text" class="form-control" required style="width: 400px"
						name="p1_id_mentor"> <br /> <br /> <br />
					<p>
						En caso de no recordar el nombre de usuario o ID de su mentor haga
						<a href="#">click aqui</a> <br />En caso de no tener ningun
						mentor haga <a href="#">click aqui</a>
					</p>
				</div>
