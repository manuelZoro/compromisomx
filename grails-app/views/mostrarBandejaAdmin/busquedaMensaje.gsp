...
function busquedas(offset){
		...
		$("#contenido_mensaje").load("/compromisomx/MostrarBandejaAdmin/busquedaMensaje?cad="+'${query}'+"&offset="+offset+"&max=5");
}
                        	...
                        	<g:else>
                        		<div class="row altura_fila">
	                            	<div class="col-md-6"><p class="pull-right indicador_paginacion">Página ${(Integer.parseInt(num.toString()) / 5.0) + 1} de ${paginas}</p></div>
			                                ...
			                                <g:else>
			                                	<div class="pager_primero" onclick="busquedas(0)" title="Primera página"></div>
			                                	<div class="pager_anterior" onclick="busquedas(${num - 5})" title="Página anterior" id="pag_izq"></div>
			                                </g:else>
			                                ...
			                                <g:else>
			                                	<div class="pager_siguiente" onclick="busquedas(${num + 5})" title="Página siguiente" id="pag_der"></div>
			                                	<div class="pager_ultimo" title="Última página" onclick="busquedas(${(paginas -1) * 5})"></div>
			                                </g:else>
	                            </div>
                        	</g:else>
                        </div>
