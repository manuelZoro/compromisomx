						...
						<table id="pais" class="table table-bordered table-striped">
							<thead>
								<tr>
									<th>NOMBRE</th>
									<th>DESCRIPCIÓN</th>
									<th>UBICACIÓN ACTIVO</th>
									<th>UBICACIÓN INACTIVO</th>
									<th>UBICACIÓN SELECCIONADO</th>
							...
							<tbody>
								<g:each in="${TodosLosComponentes}" var="componentes" status="i">
									<tr>
										<td>${componentes.nombre}</td>
										<td>${componentes.descripcion}</td>
										<td>${componentes.ubicacion_activo}</td>
										<td>${componentes.ubicacion_inactivo}</td>
										<td>${componentes.ubicacion_seleccionado}</td>
										<td>${componentes.id_tipo_elemento}</td>
										<td>${componentes.id_area}</td>
										<td>
											<button id="modificar" type="button" class="btn btn-default" data-toggle="modal" onclick="EditarComponentes('${componentes.id}','${componentes.nombre}','${componentes.descripcion}','${componentes.ubicacion_activo}','${componentes.ubicacion_inactivo}','${componentes.ubicacion_seleccionado}','${componentes.id_tipo_elemento}','${componentes.id_area}');">
												<span class="glyphicon glyphicon-edit"></span> 
											</button>
											<g:form>
												<g:hiddenField name="id" value="${componentes.id}" />
													<span class="button">
...
<g:javascript>
	function EditarComponentes(id, nombre, descripcion, ubicacionactivo, ubicacioninactivo, ubicacionseleccionado, tipoelemento, area){
