...
<title><g:layoutTitle default="Compromiso MX"/></title>
							...
							<tr>
								<td><p class="pull-left">
										<asset:image
											...
											hspace="3" />
									</p> <small><strong>Emprendedor</strong><br> ${session.categoria}
										<asset:image src="iconografia/categorias/Normal/Bronce_16.png" /><br>
										<em> ${session.mensaje}
									</em></small></td>
							</tr>
						</table>
			...
			<div class="col-md-6">
				<div class="panel panel-default">
					<div class="panel-body">
						<table class="table table-condensed">
							<tr>
								<td><small><strong>Nombre</strong><br /> ${session.user}
										${session.primer_apellido}<br /> ${session.segundo_apellido}</small></td>
								<td><small><strong>Mentor</strong><br /> ${session.mentor}</small></td>
								<td><small><strong>Rango</strong><br /> ${session.categoria}</small></td>
								<td><small><strong>Equipo</strong><br /> ${session.equipo}</small></td>
								<td><small><strong>Fecha Autopago</strong><br /> ${session.fecha_autopago}</small></td>
								<td><small><strong>Estatus</strong><br /> ${session.estatus}</small></td>
							</tr>
						</table>
					</div>
				</div>
