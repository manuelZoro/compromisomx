...
<html lang="en">
  	<head>
        ...
        <link href="${request.contextPath}/css/calendar.css" rel="stylesheet">
        <link href="${request.contextPath}/css/calendar.min.css" rel="stylesheet">
        <link href="${request.contextPath}/css/iconFont.css" rel="stylesheet">
        <link href="${request.contextPath}/css/metro-bootstrap.css" rel="stylesheet">
        <link href="${request.contextPath}/css/metro-bootstrap-responsive.css" rel="stylesheet">
        ...
        <script src="${request.contextPath}/js/es-MX.js"></script>
        <script src="${request.contextPath}/js/app.js"></script>
        <script src="${request.contextPath}/js/calendar.js"></script>
        <script src="${request.contextPath}/js/underscore-min.js"></script>
        <script src="${request.contextPath}/js/calendar.min.js"></script>
       ...
       <!-- <script src="${request.contextPath}/js/composer.json"></script>
        <script src="${request.contextPath}/js/events.json"></script>
        <script src="${request.contextPath}/js/package.json"></script>-->
        <script src="${request.contextPath}/js/metro.min.js"></script>
        <script src="${request.contextPath}/js/metro-calendar.js"></script>
        <script src="${request.contextPath}/js/load-metro.js"></script>
        <script src="${request.contextPath}/js/jquery.widget.min.js"></script>
	</head>
