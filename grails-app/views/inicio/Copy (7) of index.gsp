					...
					<div class="panel-body">
						...
						<div class="div-carousel">
							<div id="myCarousel" class="carousel slide carrusel"
								data-ride="carousel" data-interval="3000" data-ride="carousel">
								<!-- Carousel indicators -->
									...
									<g:each in="${listaAcciones}" var="accion" status="i">
										<div class="col-md-4">
											...
											<div class="box">
												...
												<br /> <div><small> ${accion.descripcion}<em> <br />
														<a href="#">Abrir</a></em></small>
													<div class="pull-right">
														10<a href="#"><asset:image
															...
															href="#"><asset:image
																src="iconografia/datosusuario/facebook_16.png" /></a>&nbsp;<a
															href="#"><asset:image
