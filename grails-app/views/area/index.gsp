				...
				<div class="box">
					<div class="box-body table-responsive">
						<table id="area" class="table table-bordered table-striped">
							...
							<tbody>
							<g:each in="${TodasAreas}" var="area" status="i">
									...
									<td>		
											...
											onclick="EditarEstado('${area.id}','${area.nombre_area}','${area.ubicacion}');">
...
<div id="myModal" class="modal fade" tabindex="-1" role="dialog"
	...
	<g:form class="form-horizontal" controller="Area"
		action="Crear">
					...
					<div class="tab-content">
						...
						<div class='col-md-6'>
							<div class='form-group'>
								...
								<div class='col-md-8'>
									<g:textField type='text' class='form-control' id='nombre_area' name='nombre_area' placeholder='Nombre' value="" />
								</div>
						</div>
						</div>
						<div class='col-md-6'>
							<div class='form-group'>
								<label class='control-label col-md-4' for='last_name'>UBICACIÓN:</label>
								<div class='col-md-8'>
									<g:textField type='text' class='form-control' id='ubicacion' name='ubicacion' placeholder='Ubicacion' value="" />
					...
					<div class="tab-content">
						...
						<div class='col-md-6'>
							<div class='form-group'>
								<label class='control-label col-md-4' for='last_name'>NOMBRE</label>
								<div class='col-md-8'>
									<g:textField type='text' class='form-control' id='nombre_m' name='nombre_area' placeholder='Nombre' value="" />
						...
						<div class='col-md-6'>
							<div class='form-group'>
								<label class='control-label col-md-4' for='last_name'>UBICACION</label>
								<div class='col-md-8'>
									<g:textField type='text' class='form-control' id='ubicacion_m' name='ubicacion' placeholder='Ubicacion' value="" />
...
<g:javascript>
	function EditarEstado(id,nombre,ubicacion) {
		$('#myModal2').modal('show');
		document.getElementById("id_m").value = id;
		document.getElementById("nombre_m").value = nombre;
		document.getElementById("ubicacion_m").value = ubicacion;
