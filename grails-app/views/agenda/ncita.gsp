...
<body>
	<g:form controller="Agenda" action="cita_guardar" style="background-color:#961255; border-left:4px solid white;" >
		<g:hiddenField name="id" id="id" value="${cita.id}"/>		  	
	            <div>
	                <div class="row mensaje_centro">
	                    ...
	                    <div class="col-md-12"><div class="mensaje_texto1">Nueva Cita</div></div>
	                    <div class="row"><div class="col-md-12"><p>&nbsp;</p></div></div>
	                    <div class="row altura_fila">
	                        ...
	                        <div class="col-md-8">
	                        	<input required type="text" class="form-control texto_campo_principal" placeholder=""  name="nombre" id=""  pattern="[a-zA-Z]+">
	                        </div>
	                    ...
	                    <div class="row altura_fila">
	                        ...
	                        <div class="col-md-8">
	                        	<input required type="text" class="form-control texto_campo_principal" placeholder=""  name="lugar" id=""  pattern="[a-zA-Z]+">
	                        </div>
	                        <div class="col-md-1"></div>
	                    </div>
	                    <div class="row altura_fila">
	                        ...
	                        <div class="col-md-8">
	                        	<select class="form-control input-sm texto_campo_principal espaciado_campo_principal" onchange="muni(this.value);" name="estado" id="">
	                    ...
	                    <div class="row altura_fila">
	                        ...
	                        <div class="col-md-8">
	                        	<select class="form-control input-sm texto_campo_principal espaciado_campo_principal" name="municipio" id="municipio" disabled >
	                        	</select>
	                        </div>
	                        <div class="col-md-1"></div>
	                    </div>
	                    <div class="row altura_fila">
	                        ...
	                        <div class="col-md-8">
	                            <div class="row">
	                                ...
	                                <div class="col-md-3">	                                	
	                                    <input type="text" class="form-control texto_campo_principal" placeholder="DD" name="dia" id="diainicio" maxlength="2" title="DD" required pattern="(0[1-9]|[12][0-9]|3[01])">
	                                </div>                        
	                                <div class="col-md-3">
	                                    <input type="text" class="form-control texto_campo_principal" placeholder="MM" name="mes" id="mesinicio" maxlength="2" title="MM" required pattern="(0[1-9]|1[012])">
	                                </div>                        
	                                <div class="col-md-3">
	                                    <input type="text" class="form-control texto_campo_principal" placeholder="AAAA" name="anio" id="anioinicio" maxlength="4" title="AAAA" required pattern="(19|20)\d\d">
	                                </div>
	                            </div>
	                        </div>
	                        <div class="col-md-1"></div>    
	                    ...
	                    <div class="row altura_fila">
	                        ...
	                        <div class="col-md-8">
	                            <div class="row">
	                                ...
	                                <div class="col-md-3">
	                                    <input type="text" class="form-control texto_campo_principal" placeholder="DD" name="dia1" id="diafin" maxlength="2" title="DD" required pattern="(0[1-9]|[12][0-9]|3[01])">
	                                </div>                        
	                                <div class="col-md-3">
	                                    <input type="text" class="form-control texto_campo_principal" placeholder="MM" name="mes1" id="mesfin" maxlength="2" title="MM" required pattern="(0[1-9]|1[012])">
	                                </div>                        
	                                <div class="col-md-3">
	                                    <input type="text" class="form-control texto_campo_principal" placeholder="AAAA" name="anio1" id="aniofin" maxlength="4" title="AAAA" required pattern="(19|20)\d\d">
	                                </div>
	                                <div class="col-md-1"><label><input type="checkbox" id="" name="rep" onClick="" value="1" checked></label></div>
	                    ...
	                    <div class="row altura_fila">
	                        ...
	                        <div class="col-md-8">
	                        	<input required type="text" class="form-control texto_campo_principal" placeholder=""  name="comentario" id=""  pattern="[a-zA-Z]+" onblur="valida();">
	                        </div>
	                        <div class="col-md-1"></div>
	                    </div>
	                    <div class="row altura_fila">
	                        ...
	                        <div class="col-md-8">
	                            <div class="row">
	                            	<div class="col-md-1"><label><input type="checkbox" id="" name="mensaje" onClick="" value="1" checked></label></div>
	                    ...
	                    <div class="row"><div class="col-md-12"><p>&nbsp;</p></div></div>
	                    <div class="col-md-6 txt_der"><button type="submit" class="btn btn-gris btn_menu_dialogo" onClick="valida()">Aceptar</button></div>
	                    <div class="col-md-6 txt_izq"><button type="button" class="btn btn-gris btn_menu_dialogo" data-dismiss="modal">Cancelar</button></div>
	                    <div class="row"><div class="col-md-12"><p>&nbsp;</p></div></div>
	                </div>
	            </div>
	</g:form>
	...
	function valida() {
			...
			var y = parseInt(yyyy);
			var d = parseInt(dd);			
			var dia = $('#diainicio').val();			
			var mes = $('#mesinicio').val();
			var anio = $('#anioinicio').val();			
			var dia = parseInt(dia);
			var mes = parseInt(mes);
			var anio = parseInt(anio);
			var diaf = $('#diafin').val();			
			var mesf = $('#mesfin').val();
			var aniof = $('#aniofin').val();			
			var diaf = parseInt(diaf);
			var mesf = parseInt(mesf);
			var aniof = parseInt(aniof);			
		    if (parseInt(anio) >= y) {
		      $('#anioinicio').val(anio);
		      alert("año bien");    
		      if(mes >= m) {
		   ...
		   {		   		
		      $('#anioinicio').val("").focus();
		   }
		   //-----------------------------------------------VALIDACION DE LA FECHA DE FIN -----------------------------------------------------
		
		   	if (parseInt(aniof) >= y && parseInt(aniof) >= anio) {
		      $('#aniofin').val(aniof);
		      alert("año2 bien");    
		      if(mesf >= m && mesf >= mes) {
		      	if(mesf < 10)
	...
	function muni(val){		
		 var arrayValores=new Array(
	       new Array("Aguascalientes","Aguascalientes","Aguascalientes"),
	       new Array("Aguascalientes","Asientos","Asientos"),
	       new Array("Aguascalientes","Calvillo","Calvillo"),
	       new Array("Aguascalientes","Cosio","Cosio"),
	       new Array("Aguascalientes","Jesus Maria","Jesus Maria"),
	       new Array("Aguascalientes","Pabellon de Arteaga","Pabellon de Arteaga"),
	       new Array("Aguascalientes","Rincon de Romos","Rincon de Romos"),
	       new Array("Aguascalientes","San Jose de Gracia","San Jose de Gracia"),
	       new Array("Aguascalientes","San Pedro","San Pedro"),
	       new Array("Aguascalientes","El Llano","El Llano"),
	       new Array("Aguascalientes","San Francisco de los Romo","San Francisco de los Romo"),
	       new Array("Baja California","Ensenada","Ensenada"),
	       new Array("Baja California","Mexicali","Mexicali"),
	       new Array("Baja California","Tecate","Tecate"),
	       new Array("Baja California","Tijuana","Tijuana"),
	       new Array("Baja California","Playas de Rosarito","Playas de Rosarito"),
