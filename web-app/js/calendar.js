...
(function($) {
	...
	Calendar.prototype._update_month_year = function() {
		...
		var self = this;
		var activecell = 0;
		var downbox = $(document.createElement('div')).attr('id', 'cal-day-tick').html('<a href=\#mensaje_detalle_cita\> + </a>'); //esto hace que aparesca el mas en los dias que tienen eventos!!!
