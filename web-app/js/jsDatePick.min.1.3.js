...
g_l.MONTH_FWD = "Avanzar un mes";
g_l.MONTH_BCK = "Regresar un mes";
g_l.YEAR_FWD = "Avanzar un año";
g_l.YEAR_BCK = "Regresar un año";
g_l.CLOSE = "Cerrar calendario";
g_l.ERROR_2 = g_l.ERROR_1 = "Error de fecha";
g_l.ERROR_4 = g_l.ERROR_3 = "Objetivo inválido";
g_jsDatePickImagePath = "/compromisomx/images/calendar/";
	...
	if (this.oConfiguration.useMode == 2) {
		if (this.oConfiguration.target != false) {
			if (typeof (JsgetElem(this.oConfiguration.target)) != null) {
				...
				e.style.position = "relative"; //estaba absolute
				e.style.top = "18px";
				e.style.left = "0px";
	...
	while (j.getMonth() == n) {
		...
		if (this.isSelectedDay(j.getDate())) {
			...
			if (parseInt(g.getAttribute("isToday")) == 1) {
				...
				g.style.background = "urlo(" + this.oConfiguration.imgPath
